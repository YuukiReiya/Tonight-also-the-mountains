...
public:
	...
	/*! セッター */
	void SetPos(D3DXVECTOR2 pos) { m_CharaPos = pos; }											/*!< 位置 */
	...
	bool SetLTIndex(unsigned int U, unsigned int V);											/*!< 分割したインデックス */

	/*! ゲッター */
	D3DXVECTOR2 GetSize()const { return { m_Width,m_Height }; }
